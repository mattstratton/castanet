...
| `apple_podcasts_subscribe`      | No       | The URL of your podcast in the Apple Podcasts store. |
...
| `social_image`           | No       | The default social sharing image (Open Graph/Twitter/etc) for your site. Used for any page that does not have `images` set in its frontmatter, including the homepage. This image should be relative to your baseURL or a full URL. | "img/default-social.jpg" |
...
| `apple_podcasts_subtitle`            | No       | No Markdown or HTML.                                                                                                                                                                | "The best podcast ever"                                                                                                                                                                        |
| `apple_podcasts_author`              | Yes      | The author name for your show. No Markdown or HTML.                                                                                                                                 | "Matt Stratton"                                                                                                                                                                                |
| `apple_podcasts_summary`             | Yes      | Limited to 4000 characters or less, plain text, no HTML.                                                                                                                            | "The HugoCast is the best podcast you've ever seen. You will learn everything you ever needed to know about podcasting from the most inspiring experts to ever show up on the whole internet." |
| `apple_podcasts_owner_name`          | Yes      | The name associated with the owner of the podcast on Apple Podcasts. Will not be displayed publicly on Apple Podcasts.                                                                              | "Matt Stratton"                                                                                                                                                                                |
| `apple_podcasts_owner_email`         | Yes      | The e-mail address that will be used to contact the owner of the podcast for communication specifically about their podcast on Apple Podcasts. It will not be publicly displayed on Apple Podcasts. | "your.name@gmail.com"                                                                                                                                                                          |
| `apple_podcasts_image`               | Yes      | Fully qualified path to your podcast's artwork for Apple Podcasts. Must conform to the [Apple Podcasts image requirements](https://help.apple.com/itc/podcasts_connect/#/itc1723472cb), and be a JPG or PNG with a minimum of 1400 x 1400 pixels and a maximum of 3000 x 3000 pixels. | "https://www.arresteddevops.com/img/ado-podcast-logo.png"                                                                                                                                      |
| `apple_podcasts_top_category`        | Yes      | The main category for your podcast in Apple Podcasts                                                                                                                                        | "Technology"                                                                                                                                                                                   |
| `apple_podcasts_first_sub_category`  | No       | The first sub-category for your podcast in Apple Podcasts                                                                                                                                   | "Software How-To"                                                                                                                                                                              |
| `apple_podcasts_second_sub_category` | No       | The second sub-category for your podcast in Apple Podcasts. Do not set this if you didn't set the first one.                                                                                | "Tech News"                                                                                                                                                                                    |
...
| `shortname` | No       | The slug/shortname for the host, used to link from the jumbotron/sidebar to the host's page. Should match the filename (without extension) in content/host/. | "matt" |
